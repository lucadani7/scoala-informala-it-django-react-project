...
const SignupPage = () => {
    ...
    const validateRegister = () => {
        ...
        let validator = Form.validator({
            name: {
                ...
                value: email, isRequired: true, isEmail: true
            }, password: {
                value: password, isRequired: true, minLength: 8
            }
        });
    ...
    return (<div className="row g-0 auth-wrapper">
                        ...
                        <div className="auth-form-container text-start">
                            <form className="auth-form" method="POST" onSubmit={register} autoComplete={'off'}>
                                ...
                                <div className="password mb-3">
                                    <div className="input-group">
                                        ...
                                        <button type="button" className="btn btn-outline-primary btn-sm"
                                            ...
                                            className={showPassword ? 'far fa-eye' : 'far fa-eye-slash'}></i></button>
                                ...
                                <div className="text-center">
                                    <button type="submit" className="btn btn-primary w-100 theme-btn mx-auto">Sign Up
                                    </button>
                                </div>
                            </form>

                            <hr/>
                            <div className="auth-option text-center pt-2">Have an account? <Link className="text-link"
                                                                                                 to="/login">Sign
                                in</Link></div>
                        </div>
                    </div>
